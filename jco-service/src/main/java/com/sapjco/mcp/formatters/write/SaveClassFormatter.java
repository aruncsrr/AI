...
/**
 * Formatter for SaveClass tool responses.
 * SAP typically returns empty body on success, or error details on failure.
 */
@Slf4j
@Component
public class SaveClassFormatter extends AbstractADTFormatter {
    ...
    public String format(String rawResponse) throws FormattingException {
        ...
        sb.append("Save Class Result\n");
        sb.append(boxDivider(60)).append("\n\n");

        if (rawResponse == null || rawResponse.trim().isEmpty()) {
            sb.append("Status: SUCCESS\n\n");
            sb.append("The class was saved successfully.\n");
            sb.append("Note: The class is saved but NOT activated.\n");
    ...
    private String parseErrorMessage(String response) {
        // Try to extract error message from common XML patterns
        ...
        // Return raw response if cannot parse
        return response;
    }
}
