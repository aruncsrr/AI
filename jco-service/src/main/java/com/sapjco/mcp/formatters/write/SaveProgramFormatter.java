...
/**
 * Formatter for SaveProgram tool responses.
 * SAP typically returns empty body on success, or error details on failure.
 */
@Slf4j
@Component
public class SaveProgramFormatter extends AbstractADTFormatter {
    ...
    public String format(String rawResponse) throws FormattingException {
        ...
        sb.append("Save Program Result\n");
        sb.append(boxDivider(60)).append("\n\n");

        if (rawResponse == null || rawResponse.trim().isEmpty()) {
            sb.append("Status: SUCCESS\n\n");
            sb.append("The program was saved successfully.\n");
            sb.append("Note: The program is saved but NOT activated.\n");
