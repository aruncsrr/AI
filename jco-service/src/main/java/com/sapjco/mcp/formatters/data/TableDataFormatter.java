...
/**
 * Formatter for PreviewTableData tool responses.
 * Converts raw SAP data preview XML (columnar format) into human-readable table format.
 */
@Slf4j
@Component
public class TableDataFormatter extends AbstractADTFormatter {
    ...
    public String format(String rawResponse) throws FormattingException {
        ...
        return formatDataPreview(rawResponse, "Table", 100);
    }

    /**
     * Format with additional context about the table name and max rows.
     */
    public String format(String rawResponse, String tableName, int maxRows) throws FormattingException {
        if (rawResponse == null || rawResponse.trim().isEmpty()) {
            throw FormattingException.emptyResponse(getToolName());
        }

        return formatDataPreview(rawResponse, tableName, maxRows);
    }
     ...
     * <pre>
     * &lt;dataPreview:columns&gt;
     *   &lt;dataPreview:metadata dataPreview:name="COL" dataPreview:type="C" .../&gt;
     *   &lt;dataPreview:dataSet&gt;
     ...
     * Tries "dataPreview:" prefixed version first, then unprefixed.
     */
    ...
    private String formatDataPreview(String xml, String tableName, int maxRows) {
