...
/**
 * Formatter for GetATCFindings tool responses.
 * Converts raw ATC findings XML into human-readable report.
 */
@Slf4j
@Component
public class ATCFindingsFormatter extends AbstractADTFormatter {
    ...
    public String format(String rawResponse) throws FormattingException {
        ...
        return formatAtcFindings(findings);
    }
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // ATC Findings Formatting
    // ═══════════════════════════════════════════════════════════════════════════

    private String formatAtcFindings(List<AtcFinding> findings) {
        StringBuilder sb = new StringBuilder();
        sb.append("ATC Findings\n");
