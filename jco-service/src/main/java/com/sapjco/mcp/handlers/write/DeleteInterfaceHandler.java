...
/**
 * Handler for DeleteInterface tool.
 * Deletes an ABAP interface via ADT REST API.
 *
...
public class DeleteInterfaceHandler implements ToolHandler {
    ...
    public Tool getToolDefinition() {
        return ToolSchemaBuilder.builder()
                ...
                .requiredString("interface_name",
                        "Name of the ABAP interface to delete")
                ...
                .buildTool(
                        "DeleteInterface",
                        "Delete an ABAP interface. WARNING: This operation is irreversible. " +
                        "The interface will be permanently deleted. " +
    ...
    public CallToolResult handle(McpSyncServerExchange exchange, CallToolRequest request) {
        ...
        log.info("DeleteInterface called: {} (session: {}, transport: {})",
                interfaceName, sessionId, transportNumber != null ? transportNumber : "(none)");
        ...
        try {
            ...
            result.append("Interface deleted successfully!\n\n");
            ...
            log.error("DeleteInterface failed for {}", interfaceName, e);
