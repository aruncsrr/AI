...
/**
 * Handler for SaveBehaviorDefinition tool.
 * Saves RAP Behavior Definition (BDEF) source code via atomic lock/save/unlock operation.
 */
@Slf4j
@Component
public class SaveBehaviorDefinitionHandler extends AbstractWriteHandler {
    ...
    public Tool getToolDefinition() {
        return ToolSchemaBuilder.builder()
                ...
                .requiredString("bdef_name", "Name of the behavior definition")
                .optionalString("source_code",
                        "Complete behavior definition source code (provide this OR source_file)")
                .optionalString("source_file",
                        "Path to file containing source code (provide this OR source_code). " +
                        "Use file paths returned by GetBehaviorDefinition for easy edit-save workflows.")
                ...
                .buildTool(
                        ...
                        "Save RAP Behavior Definition (BDEF) source code via JCo. REQUIRED: Must provide " +
    ...
    public CallToolResult handle(McpSyncServerExchange exchange, CallToolRequest request) {
        ...
        validation = validateRequired(args, "bdef_name");
        if (validation != null) return validation;
        ...
        log.info("SaveBehaviorDefinition called: {} (session: {}, transport: {}, source: {})",
                bdefName, sessionId, transportNumber != null ? transportNumber : "(auto)",
        ...
        try {
            ...
            String rawResponse = atomicSaveObject(sessionId, bdefName, "BEHAVIOR_DEFINITION",
                    effectiveSourceCode, transportNumber);

            return formatSaveResponse(resolved, rawResponse);

        } catch (Exception e) {
            return handleSaveError(bdefName, e);
        }
    }
}
