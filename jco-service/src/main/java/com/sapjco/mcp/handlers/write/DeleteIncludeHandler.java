...
/**
 * Handler for DeleteInclude tool.
 * Deletes an ABAP include program via ADT REST API.
 *
...
public class DeleteIncludeHandler implements ToolHandler {
    ...
    public Tool getToolDefinition() {
        return ToolSchemaBuilder.builder()
                ...
                .requiredString("include_name",
                        "Name of the ABAP include program to delete")
                ...
                .buildTool(
                        "DeleteInclude",
                        "Delete an ABAP include program. WARNING: This operation is irreversible. " +
                        "The include will be permanently deleted. " +
    ...
    public CallToolResult handle(McpSyncServerExchange exchange, CallToolRequest request) {
        ...
        log.info("DeleteInclude called: {} (session: {}, transport: {})",
                includeName, sessionId, transportNumber != null ? transportNumber : "(none)");
        ...
        try {
            ...
            result.append("Include deleted successfully!\n\n");
            ...
            log.error("DeleteInclude failed for {}", includeName, e);
