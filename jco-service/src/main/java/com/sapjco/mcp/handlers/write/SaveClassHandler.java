...
/**
 * Handler for SaveClass tool.
 * Saves ABAP class source code via atomic lock/save/unlock operation.
 */
@Slf4j
@Component
public class SaveClassHandler extends AbstractWriteHandler {
    ...
    public Tool getToolDefinition() {
        return ToolSchemaBuilder.builder()
                ...
                .optionalString("source_code", "Complete ABAP class source code (provide this OR source_file)")
                .optionalString("source_file",
                        "Path to file containing ABAP source code (provide this OR source_code). " +
                        "Use file paths returned by GetClass for easy edit-save workflows.")
                ...
                .buildTool(
                        "SaveClass",
                        "Save ABAP class source code via JCo. REQUIRED: Must provide session_id from CreateSession. " +
    ...
    public CallToolResult handle(McpSyncServerExchange exchange, CallToolRequest request) {
        ...
        log.info("SaveClass called: {} (session: {}, transport: {}, source: {})",
        ...
        try {
            ...
            String rawResponse = atomicSaveObject(sessionId, className, "CLASS",
