...
/**
 * Handler for DeleteClass tool.
 * Deletes an ABAP class via ADT REST API.
 *
...
public class DeleteClassHandler implements ToolHandler {
    ...
    public Tool getToolDefinition() {
        return ToolSchemaBuilder.builder()
                ...
                .requiredString("class_name",
                        "Name of the ABAP class to delete")
                ...
                .buildTool(
                        "DeleteClass",
                        "Delete an ABAP class. WARNING: This operation is irreversible. " +
                        "The class and all its includes will be permanently deleted. " +
    ...
    public CallToolResult handle(McpSyncServerExchange exchange, CallToolRequest request) {
        ...
        log.info("DeleteClass called: {} (session: {}, transport: {})",
                className, sessionId, transportNumber != null ? transportNumber : "(none)");
        ...
        try {
            ...
            result.append("Class deleted successfully!\n\n");
            ...
            log.error("DeleteClass failed for {}", className, e);
